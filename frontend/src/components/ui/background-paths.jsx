        ...
        <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    >
                        {subtitle} <br />
                        <span className="text-white font-medium">WebRTC. IPFS. Ethereum.</span>
                    </motion.p>
                    ...
                    >
                        <button
                            onClick={onAction}
                            className="group relative px-10 py-4 bg-white text-black font-black tracking-[0.2em] rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] flex items-center gap-2"
                        >
                            {account ? "ENTER DASHBOARD" : "CONNECT WALLET"} <Zap size={18} className="fill-black text-black" />
                        </button>
                    </motion.div>
                </motion.div>
            </div>
